      ...
      <Grid container columnSpacing={8} rowSpacing={4}>
        ...
        <Grid item xs={6}>
          <TextBox sx={{ mt: -2, pt: 8 }}>
            <p>
              The Systemic Risk Assessment Tool (SRAT) supports climate adaptation decision-making by identifying
              spatial criticalities and risks under current and future climate scenarios.
            </p>
          ...
          <TextBox sx={{ backgroundColor: 'rgba(255, 255, 255, 0.9)' }}>
            ...
            >
              ...
              >
                <img
                  height="80"
                  src="/logo-southampton.png"
                  alt="University of Southampton Transportation Research Group"
                />
              </a>
              <a href="https://opsis.eci.ox.ac.uk" target="_blank" rel="noopener noreferrer">
            ...
            <p>
              This research was funded by UKAID through the UK Foreign, Commonwealth &amp; Development Office under the
              High Volume Transport Applied Research Programme, which is managed by DT Global.{' '}
            </p>
            ...
            <p>
              <small>Photo credit: Flooding in the Tana River, Kenya, 1988. US National Archives, Public domain.</small>
            </p>
          </TextBox>
        </Grid>
      </Grid>
