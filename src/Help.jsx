...
const HazardHelp = () => (
  <div className="custom-map-control top-right selected-feature">
    ...
    <table className="table table-sm">
      ...
      <tbody>
        <tr>
          <td>Fluvial (river) flooding, from <a target="_blank" href="https://www.wri.org/data/aqueduct-floods-hazard-maps">WRI Aqueduct</a></td>
        ...
        <tr>
          <td>Coastal flooding with subsidence (median value), from <a target="_blank" href="https://www.wri.org/data/aqueduct-floods-hazard-maps">WRI Aqueduct</a></td>
        </tr>
        <tr>
          <td>Cyclones, from <a target="_blank" href="https://data.4tu.nl/articles/dataset/STORM_tropical_cyclone_wind_speed_return_periods/12705164/2">STORM IBTrACS model</a></td>
...
const VietnamHelp = () => (
  <div className="custom-map-control top-right selected-feature">
    ...
    Bank, Washington DC. DOI: <a target="_blank" href="http://dx.doi.org/10.1596/32412">10.1596/32412</a>.
    </p>
