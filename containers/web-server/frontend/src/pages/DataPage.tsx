      ...
      <Table aria-label="simple table">
        ...
        <TableBody>
          <TableRow>
            ...
            <TableCell>
              Ward, P.J., H.C. Winsemius, S. Kuzma, M.F.P. Bierkens, A. Bouwman, H. de Moel, A. Díaz
              Loaiza, et al. 2020. “Aqueduct Floods Methodology.” Technical Note. Washington, D.C.:
              World Resources Institute. Available online at:{' '}
              <a href="https://www.wri.org/publication/aqueduct-floods-methodology">
                www.wri.org/publication/aqueduct-floods-methodology
              </a>
              .
            </TableCell>
            <TableCell>
              All the products, methodologies, and datasets that make up Aqueduct are available for
              use under the{' '}
            ...
            <TableCell>
              Inundation depth in meters for coastal and riverine floods over 1km grid squares. 1 in
              2 to 1 in 1000 year return periods. Baseline, RCP 4.5 &amp; 8.5 emission scenarios.
              Current and future maps in 2030, 2050 and 2080.
            </TableCell>
          </TableRow>
          <TableRow>
            ...
            <TableCell>
              Lange, S., Volkholz, J., Geiger, T., Zhao, F., Vega, I., Veldkamp, T., et al. (2020).
              Projecting exposure to extreme climate impact events across six event categories and
              three spatial scales. Earth's Future, 8, e2020EF001616.{' '}
              <a href="https://doi.org/10.1029/2020EF001616">DOI 10.1029/2020EF001616</a>
            </TableCell>
          ...
          <TableRow>
            ...
            <TableCell>
              ...
              {' and '}{' '}
              <a href="https://data.4tu.nl/articles/dataset/STORM_climate_change_tropical_cyclone_wind_speed_return_periods/14510817/3">
                Future climate{' '}
              </a>
              .
            </TableCell>
            <TableCell>
              Bloemendaal, Nadia; de Moel, H. (Hans); Muis, S; Haigh, I.D. (Ivan); Aerts, J.C.J.H.
              (Jeroen) (2020): STORM tropical cyclone wind speed return periods. 4TU.ResearchData.
              Dataset. <a href="https://doi.org/10.4121/12705164.v3">DOI 10.4121/12705164.v3</a> and
              Bloemendaal, Nadia; de Moel, Hans; Dullaart, Job; Haarsma, R.J. (Reindert); Haigh,
              I.D. (Ivan); Martinez, Andrew B.; et al. (2022): STORM climate change tropical cyclone
              wind speed return periods. 4TU.ResearchData. Dataset.{' '}
              <a href="https://doi.org/10.4121/14510817.v3">DOI 10.4121/14510817.v3</a>
            </TableCell>
            <TableCell>CC0 1.0</TableCell>
            <TableCell>
              Tropical cyclone maximum wind speed (in m/s) return periods, generated using the STORM
          ...
          <TableRow>
            ...
            <TableCell>
              Pagani M, Garcia-Pelaez J, Gee R, Johnson K, Silva V, Simionato M, Styron R, Vigano D,
              Danciu L, Monelli D, Poggi V, Weatherill G. (2019). The 2018 version of the Global
              Earthquake Model: Hazard component. Earthquake Spectra, 36(1),{' '}
              <a href="https://doi.org/10.1177/8755293020931866">DOI: 10.1177/8755293020931866</a>.
            </TableCell>
            <TableCell>
              ...
              <a href="mailto:info@globalquakemodel.org">contact GEM</a> for more information.
            </TableCell>
            <TableCell>
              The Global Earthquake Model (GEM) Global Seismic Hazard Map (version 2018.1) depicts
              the geographic distribution of the Peak Ground Acceleration (PGA) with a 10%
              probability of being exceeded in 50 years, computed for reference rock conditions
              (shear wave velocity, VS30, of 760-800 m/s).
            </TableCell>
          </TableRow>
        </TableBody>
      </Table>
      ...
      <Table aria-label="simple table">
        ...
        <TableBody>
          <TableRow>
            ...
            <TableCell>
              Extract from OpenStreetMap October 2021. All roads tagged as trunk, motorway, primary,
              secondary or tertiary, all rail lines tagged as rail and railway stations.
            </TableCell>
          </TableRow>

          <TableRow>
            <TableCell>
              <a href="https://doi.org/10.5281/zenodo.3628142">
          ...
          <TableRow>
            ...
            <TableCell>
              ...
              approximately 35,000 power plants from 167 countries and includes thermal plants (e.g.
              coal, gas, oil, nuclear, biomass, waste, geothermal) and renewables (e.g. hydro, wind,
              solar). Each power plant is geolocated and entries contain information on plant
          ...
          <TableRow>
            ...
            <TableCell>
              ...
              Data: Open Database License http://opendatacommons.org/licenses/odbl/ Data credits: ©
          ...
          <TableRow>
            ...
            <TableCell>
              <a href="https://www.cgfi.ac.uk/spatial-finance-initiative/database-downloads/">
          ...
          <TableRow>
            ...
            <TableCell>
              <a href="https://cds.climate.copernicus.eu/cdsapp#!/dataset/satellite-land-cover?tab=overview">
                ESA Land cover classification{' '}
              </a>
            </TableCell>
            <TableCell>
              European Space Agency Climate Change Initiative Land Cover project (2021) Land cover
              classification gridded maps from 1992 to present derived from satellite observations,
              v2.1.1. https://doi.org/10.24381/cds.006f2c9a
            </TableCell>
          ...
          <TableRow>
            ...
            <TableCell>CC-BY 4.0</TableCell>
            <TableCell>
              Soil organic carbon content at 0-30cm, in tonnes/hectare, aggregated to 1000m grid.
              Soil organic carbon content (fine earth fraction) in dg/kg at 6 standard depths.
              Predictions were derived using a digital soil mapping approach based on Quantile
              Random Forest, drawing on a global compilation of soil profile data and environmental
              layers. This map is the result of resampling the mean SoilGrids 250 m predictions
              (Poggio et al. 2021) for each 1000 m cell.
            </TableCell>
          </TableRow>
        </TableBody>
      </Table>
      ...
      <Table aria-label="simple table">
        ...
        <TableBody>
          <TableRow>
            ...
            <TableCell>
              <a href="https://www.nature.com/articles/s41591-020-1059-1">
            ...
            <TableCell>
              ...
              healthcare facilities. Nat Med 26, 1835–1838 (2020).
          ...
          <TableRow>
            ...
            <TableCell>
              <a href="https://globaldatalab.org/shdi/">
            ...
            <TableCell>
              ...
              https://globaldatalab.org/shdi/. The SHDI is an average of the subnational values of
              three dimensions: education, health and standard of living. To compute the SHDI on the
              ...
              offices (including Eurostat, the statistical office of the European Union), the Area
              Database of the Global Data Lab, and data from the HDI website of the Human
              ...
              indicators are only available for a restricted number of years. To obtain their values
              for the whole period 1990–2017, the missing information was estimated by interpolation
              or extrapolation techniques. This estimation process was facilitated by the fact that
              the UNDP Database contains the national values for all four indicators for each year
              in this period, which means that only the subnational variation had to be interpolated
              or extrapolated. For a complete list of sources and surveys used, please refer to the
              Area Database's Data Sources page.
            </TableCell>
            <TableCell>
              Free for use with acknowledgement of data source https://globaldatalab.org/termsofuse/
            </TableCell>
            <TableCell>
              Development, Health, Education and Income indices for 186 countries, 1783 sub-national
              regions
            </TableCell>
          </TableRow>
          <TableRow>
            ...
            <TableCell>
              <a href="https://data.nhm.ac.uk/dataset/global-map-of-the-biodiversity-intactness-index-from-newbold-et-al-2016-science/resource/8531b4dc-bd44-4586-8216-47b3b8d60e85">
                Biodiversity Intactness Index
              </a>
            </TableCell>
            <TableCell>
              Tim Newbold; Lawrence Hudson; Andy Arnell; Sara Contu et al. (2016). Map of
              Biodiversity Intactness Index (from Global map of the Biodiversity Intactness Index,
              from Newbold et al. (2016) Science) [Data set resource]. Natural History Museum.
          ...
          <TableRow>
            ...
            <TableCell>
              <a href="https://www.protectedplanet.net/en/thematic-areas/wdpa?tab=WDPA">
                World Database of Protected Areas
              </a>
            </TableCell>
            <TableCell>
              UNEP-WCMC and IUCN (2022), Protected Planet: The World Database on Protected Areas
              (WDPA) [On-line], [October 2022], Cambridge, UK: UNEP-WCMC and IUCN. Available at:
          ...
          <TableRow>
            ...
            <TableCell>
              <a href="https://www.nature.com/articles/s41467-020-19493-3">
                Forest Landscape Integrity Index
              </a>
            </TableCell>
            <TableCell>
              Grantham, H.S., Duncan, A., Evans, T.D. et al. Anthropogenic modification of forests
              means only 40% of remaining forests have high ecosystem integrity. Nat Commun 11, 5978
              (2020). https://doi.org/10.1038/s41467-020-19493-3 Data are available at
              www.forestlandscapeintegrity.com. The datasets used to develop the Forest Landscape
              Integrity Index can be found at the following websites: tree cover and loss
              http://earthenginepartners.appspot.com/science-2013-global-forest, tree cover loss
              driver https://data.globalforestwatch.org/datasets/f2b7de1bdde04f7a9034ecb363d71f0e,
